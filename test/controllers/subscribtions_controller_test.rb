...
class SubscribtionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subscribtion" do
    assert_difference("Subscribtion.count") do
      post subscribtions_url, params: { subscribtion: { book_id: @subscribtion.book_id, finish: @subscribtion.finish, is_active: @subscribtion.is_active, start: @subscribtion.start, subscriber_id: @subscribtion.subscriber_id } }
    end
  ...
  test "should update subscribtion" do
    patch subscribtion_url(@subscribtion), params: { subscribtion: { book_id: @subscribtion.book_id, finish: @subscribtion.finish, is_active: @subscribtion.is_active, start: @subscribtion.start, subscriber_id: @subscribtion.subscriber_id } }
